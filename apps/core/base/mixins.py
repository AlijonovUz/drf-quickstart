"""
ViewSet va APIView'lar uchun umumiy mixinlar.

Ushbu modul dinamik huquqlarni o'rnatish (DynamicPermissionMixin) hamda
Swagger/OpenAPI teglarini avtomatik generatsiya qilish (AutoSchemaMixin) imkoniyatini beradi.
"""
...
class DynamicPermissionMixin:
    """
    Model ruxsatlarini avtomatik tekshiruvchi mixin (FullDjangoModelPermissions).
    """
...
class AutoSchemaMixin:
    """
    Swagger/OpenAPI hujjatlari uchun tag'larni avtomatik aniqlab va biriktirib beruvchi mixin.
    """

    def __init_subclass__(cls, **kwargs):
        """
        Subklass yaratilayotganda avtomatik ravishda OpenAPI tegini (tag) aniqlaydi va extend_schema orqali biriktiradi.
        """
